...
ImGuiOverlay/
â”œâ”€// Core/
â”?   â””â”€// OverlayApp.cs          â†? Silk.NET window, OpenGL, ImGui init (DOCKING ON)
â”œâ”€// Theme/
â”?   â””â”€// OverlayTheme.cs        â†? â˜? ONE FILE for all colors, roundings, thicknesses
â”œâ”€// Config/
â”?   â”œâ”€// ConfigManager.cs       â†? JSON save/load for any settings object
â”?   â””â”€// OverlaySettings.cs     â†? All feature toggles / behavior values
â”œâ”€// Rendering/
â”?   â”œâ”€// EspRenderer.cs         â†? Boxes, health bars, skeletons, snaplines
â”?   â””â”€// RadarRenderer.cs       â†? Mini-map canvas, FOV cone, zoom, rotate
â”œâ”€// UI/
â”?   â”œâ”€// NavigationBar.cs       â†? Free-floating movable tab bar
â”?   â”œâ”€// OverlayWindowManager.csâ†? Dockspace, watermark, crosshair HUD
â”?   â””â”€// Menus/
â”?       â”œâ”€// AllMenus.cs        â†? ESP / Aimbot / Radar / Visuals panels
â”?       â””â”€// ConfigMenu.cs      â†? Live theme editor + profile manager
â”œâ”€// configs/
â”?   â””â”€// theme_default.json     â†? Default theme (editable externally)
â””â”€// Program.cs
```
...
| `ImGuiCol.NavHighlight` â†? `NavCursor` | Raw index `style.Colors[54]` |
...
### âœ? Docking (ImGui Docking Branch)
...
### âœ? Live Theme Editor (Config Menu)
